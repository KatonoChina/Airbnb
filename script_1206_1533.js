...
const btnCheckIn = document.querySelector(".checkin-box-c");
const btnCheckOut = document.querySelector(".checkout-box-c");
...
const btnHideBox2 = function(){
    btnLocation.addEventListener("click", function(){
        btnLocation.classList.toggle('hide-box2-selected');
